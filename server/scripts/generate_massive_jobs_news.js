...
// The 50 highly authentic, premium Big Tech jobs
const jobs = [
  {
    id: 1,
  ...
  },
  {
    ...
    postedDays: 3,
    logo: '🟢',
    skills: ['C++', 'CUDA', 'LLVM', 'PyTorch Compilation', 'GPU Architecture', 'Python'],
    experience: 'Lead',
    category: 'AI/ML',
    featured: true,
    urgent: true,
    tags: ['NVIDIA', 'CUDA', 'Compilers'],
    applicants: 15,
  ...
  },
  {
    ...
    type: 'Remote',
    salary: '$300k – $450k',
    salaryMin: 25000000, // INR Equivalent representation
    salaryMax: 38000000,
    posted: '1 day ago',
    postedDays: 1,
    logo: '👁️',
    skills: ['Python', 'Rust', 'PyTorch', 'Generative Voice', 'Large Language Models', 'Distributed Inference'],
    experience: 'Senior',
    category: 'AI/ML',
    featured: true,
    urgent: true,
    tags: ['Remote', 'OpenAI', 'Generative AI'],
    applicants: 156,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '♾️',
    skills: ['Figma', 'Prototyping', 'User Research', 'Product Strategy', 'UI/UX Design'],
    experience: 'Senior',
    category: 'Full Stack', // Design Category mapping
    featured: false,
    urgent: false,
    tags: ['Meta', 'Figma', 'Instagram'],
    applicants: 42,
  ...
  },
  {
    ...
    postedDays: 2,
    logo: '🍿',
    skills: ['React', 'TypeScript', 'Web Performance', 'Node.js', 'Redux', 'Design Systems'],
    experience: 'Senior',
    category: 'Full Stack',
    featured: true,
    urgent: false,
    tags: ['Remote', 'React', 'Netflix'],
    applicants: 89,
  ...
  },
  {
    ...
    postedDays: 5,
    logo: '🍎',
    skills: ['Swift', 'Objective-C', 'Metal', 'CoreGraphics', 'C++', 'iOS SDK'],
    experience: 'Senior',
    category: 'Mobile',
    featured: false,
    urgent: false,
    tags: ['Apple', 'Swift', 'Metal'],
    applicants: 31,
  ...
  },
  {
    ...
    postedDays: 2,
    logo: '💳',
    skills: ['Ruby', 'Go', 'Distributed Systems', 'MySQL', 'APIs', 'High Availability'],
    experience: 'Staff',
    category: 'Backend',
    featured: true,
    urgent: true,
    tags: ['Remote', 'Go', 'Stripe'],
    applicants: 112,
  ...
  },
  {
    ...
    postedDays: 0,
    logo: '▲',
    skills: ['Next.js', 'React', 'TailwindCSS', 'TypeScript', 'Technical Writing', 'Public Speaking'],
    experience: 'Mid Level',
    category: 'Full Stack',
    featured: true,
    urgent: false,
    tags: ['Remote', 'Vercel', 'Next.js'],
    applicants: 245,
  ...
  },
  {
    ...
    postedDays: 6,
    logo: '❄️',
    skills: ['Java', 'C++', 'Python', 'SQL', 'Data Warehousing', 'Distributed Query Optimization'],
    experience: 'Senior',
    category: 'Backend',
    featured: false,
    urgent: false,
    tags: ['Snowflake', 'Database', 'Pune'],
    applicants: 19,
  ...
  },
  {
    ...
    postedDays: 3,
    logo: '🐕',
    skills: ['Go', 'Kubernetes', 'Linux Kernel', 'AWS', 'Prometheus', 'Terraform'],
    experience: 'Lead',
    category: 'DevOps',
    featured: true,
    urgent: true,
    tags: ['Datadog', 'Kubernetes', 'SRE'],
    applicants: 29,
  ...
  },
  {
    ...
    postedDays: 7,
    logo: '🐙',
    skills: ['Static Analysis', 'AppSec', 'Ruby on Rails', 'Go', 'OAuth', 'Threat Modeling'],
    experience: 'Senior',
    category: 'Cybersecurity',
    featured: false,
    urgent: false,
    tags: ['Remote', 'Security', 'GitHub'],
    applicants: 38,
  ...
  },
  {
    ...
    postedDays: 5,
    logo: '🅰️',
    skills: ['C++', 'React', 'TypeScript', 'WebAssembly', 'WebGL', 'Node.js'],
    experience: 'Senior',
    category: 'Full Stack',
    featured: false,
    urgent: false,
    tags: ['Adobe', 'Noida', 'React'],
    applicants: 47,
  ...
  },
  {
    ...
    postedDays: 2,
    logo: '🚗',
    skills: ['Kotlin', 'Java', 'Android SDK', 'RxJava', 'Dagger/Hilt', 'System Architecture'],
    experience: 'Senior',
    category: 'Mobile',
    featured: true,
    urgent: false,
    tags: ['Uber', 'Kotlin', 'Android'],
    applicants: 54,
  ...
  },
  {
    ...
    postedDays: 3,
    logo: '🎵',
    skills: ['Java', 'C++', 'Python', 'Kafka', 'Google Cloud', 'Distributed Systems'],
    experience: 'Mid Level',
    category: 'Backend',
    featured: false,
    urgent: false,
    tags: ['Remote', 'Java', 'Spotify'],
    applicants: 74,
  ...
  },
  {
    ...
    postedDays: 7,
    logo: '🦅',
    skills: ['Malware Analysis', 'Reverse Engineering', 'Threat Hunting', 'YARA', 'Python', 'Network Forensics'],
    experience: 'Senior',
    category: 'Cybersecurity',
    featured: false,
    urgent: false,
    tags: ['CrowdStrike', 'Security', 'Pune'],
    applicants: 16,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '🛡️',
    skills: ['Prisma Cloud', 'AWS Security', 'Azure Security', 'Kubernetes Security', 'IAM', 'Compliance'],
    experience: 'Lead',
    category: 'Cybersecurity',
    featured: true,
    urgent: false,
    tags: ['PaloAlto', 'CloudSec', 'Architect'],
    applicants: 21,
  ...
  },
  {
    ...
    postedDays: 2,
    logo: '🟦',
    skills: ['React', 'TypeScript', 'Redux', 'Webpack', 'CSS-in-JS', 'Performance Optimization'],
    experience: 'Lead',
    category: 'Full Stack',
    featured: true,
    urgent: true,
    tags: ['Atlassian', 'React', 'Jira'],
    applicants: 41,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '🎨',
    skills: ['Product Roadmap', 'Agile', 'Figma', 'UX/UI Research', 'SQL', 'Data Analytics'],
    experience: 'Senior',
    category: 'Full Stack', // PM role map
    featured: true,
    urgent: false,
    tags: ['Remote', 'Figma', 'PM'],
    applicants: 134,
  ...
  },
  {
    ...
    postedDays: 6,
    logo: '🛍️',
    skills: ['React Native', 'JavaScript', 'TypeScript', 'iOS SDK', 'Android SDK', 'Performance Profiling'],
    experience: 'Senior',
    category: 'Mobile',
    featured: false,
    urgent: false,
    tags: ['Remote', 'Shopify', 'React Native'],
    applicants: 52,
  ...
  },
  {
    ...
    postedDays: 5,
    logo: '💬',
    skills: ['Go', 'Java', 'PHP/Hack', 'Redis', 'WebSockets', 'MySQL'],
    experience: 'Senior',
    category: 'Backend',
    featured: false,
    urgent: false,
    tags: ['Slack', 'Go', 'WebSockets'],
    applicants: 35,
  ...
  },
  {
    ...
    postedDays: 7,
    logo: '📈',
    skills: ['Python', 'SQL', 'NLP', 'Data Science', 'Machine Learning', 'Team Leadership'],
    experience: 'Lead',
    category: 'Data Science',
    featured: true,
    urgent: false,
    tags: ['ZoomInfo', 'Leadership', 'NLP'],
    applicants: 18,
  ...
  },
  {
    ...
    postedDays: 3,
    logo: '🎵',
    skills: ['Python', 'Scala', 'PySpark', 'Machine Learning', 'Recommendation Engines', 'A/B Testing'],
    experience: 'Senior',
    category: 'Data Science',
    featured: true,
    urgent: false,
    tags: ['Remote', 'DataScience', 'Spotify'],
    applicants: 142,
  ...
  },
  {
    ...
    postedDays: 5,
    logo: '🪙',
    skills: ['Solidity', 'Rust', 'Web3', 'Smart Contract Auditing', 'Cryptography', 'Go'],
    experience: 'Senior',
    category: 'Backend',
    featured: false,
    urgent: true,
    tags: ['Remote', 'Coinbase', 'Solidity'],
    applicants: 87,
  ...
  },
  {
    ...
    postedDays: 2,
    logo: '🕯️',
    skills: ['PyTorch', 'Python', 'Reinforcement Learning', 'RLHF', 'Mechanistic Interpretability'],
    experience: 'Senior',
    category: 'AI/ML',
    featured: true,
    urgent: true,
    tags: ['Anthropic', 'Research', 'AI Safety'],
    applicants: 98,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '🧡',
    skills: ['Rust', 'C', 'Linux Kernel', 'eBPF', 'BGP Routing', 'Anycast Network'],
    experience: 'Senior',
    category: 'DevOps',
    featured: false,
    urgent: false,
    tags: ['Cloudflare', 'Rust', 'eBPF'],
    applicants: 23,
  ...
  },
  {
    ...
    postedDays: 7,
    logo: '🪵',
    skills: ['Go', 'Terraform', 'HCL', 'Distributed Systems', 'Git', 'APIs'],
    experience: 'Senior',
    category: 'DevOps',
    featured: true,
    urgent: false,
    tags: ['Remote', 'Go', 'Terraform'],
    applicants: 154,
  ...
  },
  {
    ...
    postedDays: 5,
    logo: '🔵',
    skills: ['OIDC', 'OAuth2', 'SAML', 'Java', 'Spring Boot', 'Zero Trust'],
    experience: 'Senior',
    category: 'Cybersecurity',
    featured: false,
    urgent: false,
    tags: ['Okta', 'Noida', 'SAML'],
    applicants: 19,
  ...
  },
  {
    ...
    postedDays: 2,
    logo: '🤖',
    skills: ['Technical Writing', 'Public Speaking', 'React', 'Python', 'Community Management'],
    experience: 'Lead',
    category: 'Full Stack',
    featured: true,
    urgent: false,
    tags: ['Google', 'DevRel', 'Bengaluru'],
    applicants: 88,
  ...
  },
  {
    ...
    postedDays: 7,
    logo: '💻',
    skills: ['Microsoft Azure', 'PowerShell', 'ARM Templates', 'Active Directory', 'Monitoring'],
    experience: 'Mid Level',
    category: 'Cloud',
    featured: false,
    urgent: false,
    tags: ['Microsoft', 'Azure', 'Noida'],
    applicants: 45,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '☁️',
    skills: ['AWS Services', 'Cloud Architecture', 'Serverless', 'Terraform', 'Technical Consulting'],
    experience: 'Mid Level',
    category: 'Cloud',
    featured: false,
    urgent: false,
    tags: ['AWS', 'Startups', 'Architecture'],
    applicants: 33,
  ...
  },
  {
    ...
    postedDays: 6,
    logo: '🟦',
    skills: ['Verilog', 'SystemVerilog', 'ASIC Design', 'SoC Architecture', 'PCIE'],
    experience: 'Senior',
    category: 'Backend', // Hardware mapping
    featured: false,
    urgent: false,
    tags: ['Intel', 'Hardware', 'ASIC'],
    applicants: 14,
  ...
  },
  {
    ...
    postedDays: 5,
    logo: '📱',
    skills: ['C', 'C++', 'RTOS', 'Embedded Systems', '5G Protocols', 'Microcontrollers'],
    experience: 'Mid Level',
    category: 'Backend', // Embedded Systems map
    featured: false,
    urgent: false,
    tags: ['Qualcomm', 'Firmware', 'RTOS'],
    applicants: 22,
  ...
  },
  {
    ...
    postedDays: 7,
    logo: '🌌',
    skills: ['C++', 'OpenCV', 'Image Processing', 'CUDA', 'Camera ISP', 'Android NDK'],
    experience: 'Senior',
    category: 'AI/ML',
    featured: false,
    urgent: false,
    tags: ['Samsung', 'OpenCV', 'Camera'],
    applicants: 29,
  ...
  },
  {
    ...
    postedDays: 3,
    logo: '⚙️',
    skills: ['Vanilla JavaScript', 'HTML5', 'CSS3', 'Web Components', 'Framework Design', 'Security'],
    experience: 'Senior',
    category: 'Full Stack',
    featured: false,
    urgent: false,
    tags: ['Zoho', 'JavaScript', 'Architecture'],
    applicants: 42,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '☘️',
    skills: ['Product Roadmap', 'Agile', 'Jira', 'UI/UX Research', 'Customer Feedback', 'Analytics'],
    experience: 'Mid Level',
    category: 'Full Stack',
    featured: false,
    urgent: false,
    tags: ['Freshworks', 'Product', 'CRM'],
    applicants: 31,
  ...
  },
  {
    ...
    postedDays: 2,
    logo: '💳',
    skills: ['PHP', 'Go', 'MySQL', 'Redis', 'API Design', 'Microservices'],
    experience: 'Senior',
    category: 'Backend',
    featured: true,
    urgent: true,
    tags: ['Razorpay', 'Go', 'Fintech'],
    applicants: 51,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '💳',
    skills: ['Swift', 'UIKit', 'SwiftUI', 'CoreAnimation', 'iOS SDK', 'System Architecture'],
    experience: 'Senior',
    category: 'Mobile',
    featured: false,
    urgent: false,
    tags: ['CRED', 'SwiftUI', 'Animation'],
    applicants: 39,
  ...
  },
  {
    ...
    postedDays: 3,
    logo: '🛍️',
    skills: ['Python', 'Scala', 'TensorFlow', 'PySpark', 'RecSys', 'A/B Testing'],
    experience: 'Mid Level',
    category: 'AI/ML',
    featured: false,
    urgent: false,
    tags: ['Flipkart', 'Recommendation', 'TensorFlow'],
    applicants: 43,
  ...
  },
  {
    ...
    postedDays: 6,
    logo: '📱',
    skills: ['Penetration Testing', 'SIEM', 'PCI-DSS', 'OWASP Top 10', 'Python', 'Incident Response'],
    experience: 'Senior',
    category: 'Cybersecurity',
    featured: false,
    urgent: false,
    tags: ['Paytm', 'Security', 'PCI-DSS'],
    applicants: 17,
  ...
  },
  {
    ...
    postedDays: 7,
    logo: '⚙️',
    skills: ['AWS', 'Azure', 'Cloud Migration', 'Enterprise Architecture', 'Terraform', 'Pre-Sales'],
    experience: 'Lead',
    category: 'Cloud',
    featured: false,
    urgent: false,
    tags: ['TCS', 'Consulting', 'Migration'],
    applicants: 28,
  ...
  },
  {
    ...
    postedDays: 5,
    logo: 'ℹ️',
    skills: ['Java', 'Spring Boot', 'Hibernate', 'Microservices', 'Oracle DB', 'Design Patterns'],
    experience: 'Senior',
    category: 'Backend',
    featured: false,
    urgent: false,
    tags: ['Infosys', 'Java', 'Spring'],
    applicants: 36,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '⚙️',
    skills: ['Node.js', 'React', 'JavaScript', 'Express', 'MongoDB', 'REST APIs'],
    experience: 'Mid Level',
    category: 'Full Stack',
    featured: false,
    urgent: false,
    tags: ['Wipro', 'React', 'Node'],
    applicants: 61,
  ...
  },
  {
    ...
    postedDays: 3,
    logo: '⚙️',
    skills: ['Kubernetes', 'Docker', 'Jenkins', 'Terraform', 'Linux', 'AWS'],
    experience: 'Mid Level',
    category: 'DevOps',
    featured: false,
    urgent: false,
    tags: ['HCLTech', 'Kubernetes', 'DevOps'],
    applicants: 47,
  ...
  },
  {
    ...
    postedDays: 7,
    logo: '⚙️',
    skills: ['5G Protocols', 'NFV', 'OpenRAN', 'Cisco Network', 'SIP', 'Linux'],
    experience: 'Senior',
    category: 'Backend', // Telecom mapping
    featured: false,
    urgent: false,
    tags: ['TechM', 'Telecom', '5G'],
    applicants: 15,
  ...
  },
  {
    ...
    postedDays: 5,
    logo: '🅾️',
    skills: ['C', 'C++', 'SQL', 'Oracle DB', 'Query Optimizer', 'Operating Systems'],
    experience: 'Senior',
    category: 'Backend',
    featured: false,
    urgent: false,
    tags: ['Oracle', 'Database', 'C++'],
    applicants: 22,
  ...
  },
  {
    ...
    postedDays: 2,
    logo: '🔵',
    skills: ['Python', 'AWS Security', 'Cryptography', 'SIEM', 'Penetration Testing', 'SAML'],
    experience: 'Senior',
    category: 'Cybersecurity',
    featured: false,
    urgent: true,
    tags: ['Cisco', 'Duo', 'Security'],
    applicants: 31,
  ...
  },
  {
    ...
    postedDays: 6,
    logo: '☁️',
    skills: ['Java', 'Spring Boot', 'MuleSoft', 'Integration APIs', 'SQL', 'Kubernetes'],
    experience: 'Senior',
    category: 'Backend',
    featured: false,
    urgent: false,
    tags: ['Salesforce', 'MuleSoft', 'Java'],
    applicants: 27,
  ...
  },
  {
    ...
    postedDays: 4,
    logo: '🅰️',
    skills: ['Python', 'PyTorch', 'Generative Models', 'Computer Vision', 'Diffusion Models', 'Mathematics'],
    experience: 'Senior',
    category: 'AI/ML',
    featured: true,
    urgent: false,
    tags: ['Adobe', 'Research', 'Diffusion'],
    applicants: 34,
  ...
  },
  {
    ...
    postedDays: 0,
    logo: '🔗',
    skills: ['React', 'TypeScript', 'TailwindCSS', 'Web Performance', 'Micro-Frontends'],
    experience: 'Senior',
    category: 'Full-Stack',
    featured: true,
    urgent: true,
    tags: ['LinkedIn', 'Frontend', 'Bengaluru'],
    applicants: 8,
  ...
  },
  {
    ...
    postedDays: 1,
    logo: '⚡',
    skills: ['C++', 'Python', 'Computer Vision', 'CUDA', 'Real-time Systems', 'PyTorch'],
    experience: 'Mid-Senior',
    category: 'AI/ML',
    featured: true,
    urgent: true,
    tags: ['Tesla', 'Autopilot', 'Pune'],
    applicants: 45,
  ...
  },
  {
    ...
    postedDays: 0,
    logo: '❤️',
    skills: ['Kubernetes', 'AWS', 'Terraform', 'Go', 'Prometheus', 'Chaos Engineering'],
    experience: 'Senior',
    category: 'Cloud',
    featured: true,
    urgent: false,
    tags: ['Zomato', 'DevOps', 'Gurugram'],
    applicants: 19,
  ...
  },
  {
    ...
    postedDays: 0,
    logo: '🍔',
    skills: ['React Native', 'TypeScript', 'iOS', 'Android', 'Mobile Performance', 'GraphQL'],
    experience: 'Senior',
    category: 'Mobile',
    featured: true,
    urgent: true,
    tags: ['Swiggy', 'Mobile', 'Bengaluru'],
    applicants: 15,
  ...
  },
  {
    ...
    postedDays: 1,
    logo: '💜',
    skills: ['Cloud Security', 'Kubernetes Security', 'IAM', 'Go', 'Penetration Testing', 'SecOps'],
    experience: 'Staff',
    category: 'Security',
    featured: true,
    urgent: false,
    tags: ['PhonePe', 'Security', 'Fintech'],
    applicants: 7,
...
// Rich editorial trending articles
const articles = [
  {
...
// 1. Generate Static jobs.ts file content
function generateStaticJobsFile() {
  const filePath = path.join(projectRoot, 'src/app/data/jobs.ts');
  console.log(`Writing static jobs fallback data to: ${filePath}`);
  
  const content = `export type JobType = 'Remote' | 'Full-time' | 'Contract' | 'Government' | 'Abroad' | 'Internship' | 'Part-time';
...
`;
  ...
  console.log('✅ Static jobs file written successfully.');
}

// 2. Generate Static newsFallback.ts file content
function generateStaticNewsFile() {
  const filePath = path.join(projectRoot, 'src/app/data/newsFallback.ts');
  console.log(`Writing static news fallback data to: ${filePath}`);
  
  const newsPostsWithMetadata = articles.map((art, index) => ({
    id: 1000 + index,
    title: art.title,
    excerpt: art.excerpt,
    content: art.content,
...
export const fallbackPosts: BlogPost[] = ${JSON.stringify(newsPostsWithMetadata, null, 2)};
`;

  fs.writeFileSync(filePath, content, 'utf-8');
  console.log('✅ Static news file written successfully.');
}

// 3. Database seeding
async function syncDatabase() {
  try {
    console.log('🧹 Wiping all old jobs and posts from MySQL database...');
    
    // Purge tables in standard order to avoid constraint warnings
    await prisma.jobSkill.deleteMany();
    await prisma.jobStats.deleteMany();
    await prisma.savedJob.deleteMany();
    await prisma.jobApplication.deleteMany();
    await prisma.precisionJobMatch.deleteMany();
    ...
    console.log('🌱 Seeding 50 premium Big Tech jobs into live database...');
    for (const job of jobs) {
      ...
      await prisma.jobStats.create({
        data: {
          ...
          views_count: job.applicants * 6 + 10
        }
      });

      // Seeding detailed skills
    ...
    console.log(`✅ Seeding of ${jobs.length} jobs completed.`);

    console.log('✍️ Seeding 10 premium articles...');
    ...
    if (!admin) {
      console.warn('⚠️ Warning: Admin user not found. Seeding articles with default author ID = 1');
    } else {
      console.log(`   - Attributing articles to Admin User: ${admin.name} (ID: ${admin.id})`);
    }
    ...
    console.log('✅ Seeding of articles completed.');

    console.log('🎉 Seeding and update successfully completed!');
    process.exit(0);
  } catch (error) {
    console.error('❌ Database Sync failed with error:', error);
    process.exit(1);
  } finally {
...
// Dynamically add high-fidelity external application links based on company name
const companyUrls = {
  'google': 'https://www.google.com/about/careers/applications/',
  'microsoft': 'https://careers.microsoft.com/us/en/search-results',
  'aws': 'https://www.amazon.jobs/en/teams/amazon-web-services',
  ...
  'adobe': 'https://adobe.wd5.myworkdayjobs.com/external_careers',
  ...
  'wipro': 'https://careers.wipro.com/global-careers',
...
for (const job of jobs) {
  ...
  let matchedUrl = 'https://careerdream.in/jobs/apply-direct'; // realistic fallback
  ...
  job.externalUrl = matchedUrl;
}

// Perform generation steps
generateStaticJobsFile();
generateStaticNewsFile();
syncDatabase();
