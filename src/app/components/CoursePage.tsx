        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="space-y-4">
              <div className="rounded-2xl overflow-hidden border border-border bg-card shadow-lg aspect-video">
                {course.videoUrl ? (
                  <iframe 
                  ...
                  <div className={`w-full h-full bg-gradient-to-br ${course.color} flex items-center justify-center`}>
                    <p className="text-white font-bold text-xl">Video Coming Soon</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border bg-card">
              ...
              <div className="flex items-start gap-4">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-2xl shrink-0 border border-primary/20">
                  {course.instructor[0]}
                </div>
                <div>
                  <h3 className="font-bold text-lg text-primary mb-1">{course.instructor}</h3>
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-border bg-card overflow-hidden sticky top-24">
              ...
              <div className="p-6">
                ...
                <p className="text-center text-xs text-muted-foreground mt-3">Full lifetime access to all materials</p>
