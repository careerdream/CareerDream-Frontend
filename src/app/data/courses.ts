...
export const courses: Course[] = [
  {
    ...
    price: 'Free',
    originalPrice: 'Free',
    videoUrl: 'https://www.youtube.com/embed/i_LwzRmAENo',
    bestseller: true,
  ...
  },
  {
    ...
    price: 'Free',
    originalPrice: 'Free',
    videoUrl: 'https://www.youtube.com/embed/Ia-UEYYRCEI',
    bestseller: true,
    skills: ['AWS', 'SAP-C02', 'VPC', 'Lambda', 'Security', 'Architecture'],
    category: 'Cloud',
  ...
  },
  {
    ...
    bestseller: true,
    skills: ['Kubernetes', 'Docker', 'DevOps', 'CI/CD', 'Cloud Native', 'Containers'],
    category: 'DevOps',
    description: 'Master Kubernetes and cloud-native technologies. Learn to orchestrate containers and build automated deployment pipelines at scale.',
    whatYouLearn: [
  ...
  },
  {
    ...
    price: 'Free',
    originalPrice: 'Free',
    videoUrl: 'https://www.youtube.com/embed/inWWhwq6Zc',
  ...
  },
  {
    ...
    price: 'Free',
    originalPrice: 'Free',
    videoUrl: 'https://www.youtube.com/embed/qZRSaFBtO7U',
